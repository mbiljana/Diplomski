...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.AdPhoto", mendixObject.getType()))
			return myfirstmodule.proxies.AdPhoto.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Photos", mendixObject.getType()))
