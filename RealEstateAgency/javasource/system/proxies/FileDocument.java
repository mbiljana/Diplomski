...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Documents", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("DocumentViewer.PDF", mendixObject.getType()))
