...
public class Paging
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.CreateAvailableAppointments_DataGrid", mendixObject.getType()))
			return myfirstmodule.proxies.CreateAvailableAppointments_DataGrid.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.PendingRequests_DataGrid", mendixObject.getType()))
