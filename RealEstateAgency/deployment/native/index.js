...
import { navigationStyle } from "D:/Fakultet IV godina/IV II sem/IIS/mendix/New folder/theme/styles.js";
...
startApp({
    ...
    "onStartupNativeClient": () => {
        NativeUI.registerPage("MyFirstModule.Home_Native", require("D:/Fakultet IV godina/IV II sem/IIS/mendix/New folder/deployment/native/pages/MyFirstModule.Home_Native"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
    },
